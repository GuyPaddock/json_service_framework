 ...
 * all.
 * <p>
 * This pre-processor should only be used for values that are all right to be shared across several
 * all instances of the same model. For example, this can be used for immutable collections or
 * constant values for faster construction performance and better control over which object
