 ...
 * <p>
 * At present, this interface and the {@link ModelFilter} interface are identical, but conceptually
 * criteria and model filters are distinct. Allowing one to extend the other also has the added
